...
$btnpads = Add-Button -Control $panelsuggest -Text "Anuncios personalizados" -X $cx_ar[0] -Y $cy_ar[0] -Width 150 -Height 30 -ForeColor '#ffffff'
    $btnpads.Add_Click({$global:text="sug\provider_ads.txt"; changeregs; Update-Button-Reg -buttonChanger $btnpads});
$btnrecom = Add-Button -Control $panelsuggest -Text "Recomendaciones" -X $cx_ar[1] -Y $cy_ar[1] -Width 150 -Height 30 -ForeColor '#ffffff'
    $btnrecom.Add_Click({$global:text="sug\recomendation_tips.txt"; changeregs; Update-Button-Reg -buttonChanger $btnrecom});
$btnssug = Add-Button -Control $panelsuggest -Text "Sugerencias de inicio" -X $cx_ar[2] -Y $cy_ar[2] -Width 150 -Height 30 -ForeColor '#ffffff'
...
$btnsapps = Add-Button -Control $panelsuggest -Text "Apps sugeridas" -X $cx_ar[3] -Y $cy_ar[3] -Width 150 -Height 30 -ForeColor '#ffffff'
...
$btnscon = Add-Button -Control $panelsuggest -Text "Contenido sugerido" -X $cx_ar[4] -Y $cy_ar[4] -Width 150 -Height 30 -ForeColor '#ffffff'
...
$btntips = Add-Button -Control $panelsuggest -Text "Tips" -X $cx_ar[5] -Y $cy_ar[5] -Width 150 -Height 30 -ForeColor '#ffffff'
...
$btnwe= Add-Button -Control $panelsuggest -Text "Experiencia de bienvenida" -X $cx_ar[6] -Y $cy_ar[6] -Width 150 -Height 30 -ForeColor '#ffffff'
